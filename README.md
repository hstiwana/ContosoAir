[![Build Status](https://dev.azure.com/mrtiwana/mrtiwana/_apis/build/status/hstiwana.ContosoAir?branchName=master)](https://dev.azure.com/mrtiwana/mrtiwana/_build/latest?definitionId=1&branchName=master)
